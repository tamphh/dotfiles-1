...
# Gimp
gravity :gimp_image,     [  10,   7,  80, 91 ]
gravity :gimp_toolbox,   [   0,   7,  10, 91 ]
gravity :gimp_dock,      [  90,   7,  10, 91 ]
...
grab "W-p", "dmenu_run -i -b -nb '#1f2123' -nf '#d9d1e8' -fn 'Liberation Mono:style=Regular:size=9' -sb '#219e92'"
...
gravity :term, [ 33, 8, 34, 21 ]
gravity :wee, [ 0, 13, 29, 82 ]
gravity :mus, [ 71, 13, 29, 40 ]
gravity :cav, [ 71, 53, 29, 39 ]
gravity :mai, [ 33, 34, 34, 65 ]
...
on :start do
    ...
    Subtlext::Client.spawn( "feh --bg-fill images/creation.jpg" )
